...
public class CustomExecutor {
    ...
    public CustomExecutor(){
        ...
        this.taskQueue = new PriorityBlockingQueue<>(numOfCores,
                Comparator.comparingInt(o -> ((Task<?>) o).getTaskType().getPriorityValue()));
    ...
    public int getCurrentMax() {
        return Math.max(TaskType.OTHER.getPriorityValue(), Math.max(TaskType.COMPUTATIONAL.getPriorityValue(), TaskType.IO.getPriorityValue()));
    }
